...
return [
    ...
    */
    ...
    'accepted_if' => 'Поле :attribute должно быть подтверждено, когда :other равно :value.',
    ...
    'not_regex' => 'Выбранное значение поля :attribute недопустимо.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение поля :attribute появилось в результате утечки данных. Пожалуйста, выберите другое значение :attribute.',
    ],
    ...
    'prohibits' => 'Поле :attribute запрещает presence :other.',
    ...
    'required_unless' => 'Поле :attribute обязательно для заполнения, если только :other не равно :value.',
    ...
    'required_without_all' => 'Поле :attribute обязательно для заполнения, когда none of :values присутствуют.',
